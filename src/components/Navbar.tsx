...
import { ElectronOnly } from "./miscellaneous/electron-only";
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex flex-row justify-start items-center flex-shrink-0 gap-4">
            ...
            <ElectronOnly>
              <div className="flex flex-row justify-start items-center gap-2">
                <Button
                  value={"ghost"}
                  size={"icon"}
                  className="rounded-full bg-white text-orange-500 p-0 h-5 w-5"
